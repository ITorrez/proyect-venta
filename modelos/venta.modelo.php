...
class Venta extends Conexion{
	...
	public function reporteVentasDeUnEmpleado($fechaIni,$fechaFin,$idemp)
	{
		$sql="SELECT 
						a.id_venta,
						d.nombre_producto,
	...
	public function reporteVentasDeUnEmpleadoParaCierre($fechaIni)
	{
		$sql="SELECT 
				    a.id_venta,
				    a.fecha_venta,
             ...
             -- INNER JOIN tb_empleado as g
			  ...
			  LEFT  JOIN tb_venta_cliente as e 
			       ...
			       WHERE cast(a.fecha_venta as date) = '$fechaIni'
			         and a.estado='Activo'
			         and b.estado='Activo'
			         and not exists (SELECT cc.id_cierre_caja_venta
			         	                 FROM tb_cierre_caja_venta as cc 
			         	                WHERE cc.id_venta=a.id_venta
   ...
   /*da de baja una venta*/
	...
	public function verificarVentaEnCierre($idventa)
	{
		$sql="SELECT a.id_cierre_caja 
		        FROM tb_cierre_caja_venta as a
		       WHERE a.id_venta=$idventa
		         and a.estado='Activo' ";
              return parent::ejecutar($sql);
	}
	public function actualizarFechaVenta($idventa)
	{
		$sql="UPDATE tb_venta
		         set fecha_venta='$this->fecha_venta'
		       WHERE id_venta=$idventa
		         and estado='Activo'";
	   if (parent::ejecutar($sql)) 
			return true;
