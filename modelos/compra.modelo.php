...
class Compra extends Conexion{
	...
	public function listarCompras()
	{
		$sql="SELECT (a.id_compra)AS idcompra,
                     ...
                     (case when a.tipo_reg='admin'
                          THEN (SELECT concat(h.nombre_administrador,' ',h.apellido_administrador )
                           	       FROM tb_administrador as h 
                           	      WHERE h.id_administrador=a.usuario_alta)
                            ELSE
                             (SELECT concat(g.nombre_empleado,' ',g.apellido_empleado )
		  ...
		  inner join tb_compra_producto as b
                  ...
                  AND b.estado='Activo' 
		   inner join tb_producto as c
                   on b.id_producto=c.id_producto
		   inner join tb_proveedor as d
		          on a.id_proveedor=d.id_proveedor        
	...
	public function mostrarUnaCompra($id)
	{
       ...
       INNER JOIN tb_producto as d 
               ON b.id_producto=d.id_producto
       INNER JOIN tb_proveedor as c 
               ON a.id_proveedor=c.id_proveedor
            WHERE a.id_compra=$id";
       return parent::ejecutar($sql);
	}
	public function actualizarMontoCompra($idcompra)
	{
		$sql="UPDATE tb_compra 
		          SET monto_compra='$this->monto_compra'
		       WHERE id_compra=$idcompra";
