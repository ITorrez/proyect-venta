         ...
         <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                 ...
                 <input type="text" class="form-control input-lx" name="nuevoUsuario" id="nuevoUsuario" placeholder="Ingresar usuario" required="" autocomplete="off" >
              </div>  
            </div>
      ...
      <div class="modal-body">
         <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                 <input type="password" class="form-control input-lx" name="editPassword" id="editPassword" placeholder="Ingresar contraseña" required="">
                 <span class="input-group-addon" id="icono-mostrar-password"><i class="fa fa-eye" aria-hidden="true" action="hide" id="show-hide-passwd"></i></span>
    ...
    $('#idempedit').val(f[0]);
     $('#editNombre').val(f[1]);
      ...
      $('#selecpermisoedit').val(f[8]);  
       $('#editPassword').get(0).type='password';    
       $('#show-hide-passwd').removeClass('fa fa-eye-slash').addClass('fa fa-eye').attr('action','hide');
          // $('#textidalim').text(f[0]);
      var tipousuer=(f[6]); 
     //alert(tipousuer);
...
$(document).ready(function() { 
 ...
 function mostrarOcultatSelectPermiso()
   ...
   /*MOSTRAR Y OCULTAR CONTRASEÑA*/
    ...
    $(document).ready(function() { 
   $("#show-hide-passwd").on('click', function() {
 
       var current = $(this).attr('action');
        if (current == 'hide') {
           $('#editPassword').get(0).type='text';
