...
<div id="modalElimCierreCaja" class="modal fade" role="dialog">
         ...
         <div class="box-body">
          <input type="hidden" class="form-control input-lx" name="id_cierre" id="id_cierre" placeholder="id  cierre" required="" autocomplete="off"  value="">
           ...
           <!-- <div class="form-group">
            ...
            <label>Esta usted seguro de eliminar el cierre con codigo   &nbsp;</label><label id="codcierre"></label><label>?</label>
  ...
  //  generacionReporteCierre();
     ...
     var idemp=0;//$('#selectemp').val(); por defecto se le mandara cero como empleado, ya que debe mostrar de todos los empleados
