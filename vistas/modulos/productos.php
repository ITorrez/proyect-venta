...
<script type="text/javascript">
  $(document).ready(function() { 
   ...
   if ( (nuevoNombre=='') ||  (nuevoCodigo=='')||  (nuevoDescripcion=='')|| (selectNuevoMarca=='') ||  (selectNuevoCateg=='')) 
   {
      ...
      $.ajax({ url: 'controladores/productos.controlador.php', 
               ...
               success: function(response) { 
                ...
                //    console.info(posIdpregunta);
                  ...
                  switch (response) {
                     case '1': setTimeout(function(){ location.href='productos'; }, 1000); swal('EXELENTE','','success');    
                        break;
                     case '3': setTimeout(function(){  }, 2000); swal('ERROR','Ya existe un producto con el mismo nombre','error');
                        break;
                     case '4': setTimeout(function(){  }, 2000); swal('ERROR','Ya existe un producto con el mismo código','error');
                        break;
                     case '0': setTimeout(function(){  }, 2000); swal('ERROR','Intente nuevamente','error');
                        break;
                    default: setTimeout(function(){  }, 2000); swal('ERROR','Ocurrio un error, intente nuevamente','error');
                     break;
                    }
                }
            }); 
...
$(document).ready(function() { 
   ...
   if ( (editNombre=='') ||  (editCodigo=='')||  (editDescripcion=='') || (selecteditMarca=='') ||  (selecteditCateg=='')) 
   {
     setTimeout(function(){  }, 2000); swal('ATENCION','Deve de completar todos los campos','warning'); 
      ...
      $.ajax({ url: 'controladores/productos.controlador.php', 
               ...
               success: function(response) { 
                ...
                //    console.info(posIdpregunta);
                  ...
                  switch (response) {
                     case '1': setTimeout(function(){ location.href='productos'; }, 2000); swal('EXELENTE','','success');  
                        break;
                     case '2': setTimeout(function(){  }, 2000); swal('ERROR','No puede actualizar porque usted no dio de alta este producto','error'); 
                        break;
                     case '3': setTimeout(function(){  }, 2000); swal('ERROR','Ya existe un producto con el mismo nombre','error');
                        break;
                     case '4': setTimeout(function(){  }, 2000); swal('ERROR','Ya existe un producto con el mismo código','error');
