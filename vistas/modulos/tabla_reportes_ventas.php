...
<table class="table table-bordered table-striped ">
   ...
   /*verificacion que el precio de venta sea mayor o igual al precio de costo de producto*/     
                if ($fila->precio_unitario_venta<$fila->precio_compra_prod) 
                {
                  $alertaColor="red";
                  $colorTexto="white";
                }
                 ...
                 // $sub_costo=$fila->precio_compra_prod*$fila->cantidad_prod;   
                   // $ganacia=$fila->subtotal_venta-$sub_costo;
                    $ganacia=(($fila->precio_unitario_venta-$fila->precio_compra_prod)*$fila->cantidad_prod);
              ?>
               <tr style="background-color: <?php echo $alertaColor; ?>; color: <?php echo $colorTexto?>;">
                ...
                <!--  <td><?php echo $fila->descripcion; ?></td> -->
                 ...
                 <td><?php echo $fila->subtotal_venta; ?></td>
                  ...
                  <td>
                   <div class="btn-group">
                      <button class="btn btn-warning" data-toggle="modal" data-target="#modalModFechaventa" onclick="CargarinfoModFechaVenta('<?php echo $datosventa ?>')"><i class="fa fa-pencil"></i></button>
                   </div>
                 </td>
...
function CargarinfoVentaElim(datosventa) 
  ...
  function CargarinfoModFechaVenta(datosventa) 
  {
    
    f=datosventa.split('||');
    $('#fecha_venta_actual').val(f[4]);
    $('#id_venta').val(f[0]);
