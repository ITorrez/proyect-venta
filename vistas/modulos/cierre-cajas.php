      ...
      <div class="modal-body">
         <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                 <input type="number" class="form-control input-lx" name="monto_entregado" id="monto_entregado" placeholder="Monto entregado" required="" autocomplete="off" readonly oninput="calcularsobrante(this.value)">
              </div>  
            </div>
  ...
  //  generacionVentaCierre();
    ...
    // var fecha_fin=$('#dateFinal').val();
     var idemp=$('#selectemp').val();
      ...
      $('#divtablareportes').load('vistas/modulos/tabla_ventas_cierre.php?fini='+fecha_ini);
                    // alert(response);
      ...
      function cargadeDatosModalParaCierre()
      {
        ...
        $('#monto_entregado').val(montoventasdia);
        $('#monto_sobrante').val(0);//por defecto el campo sobrante tiene el monto ventas
