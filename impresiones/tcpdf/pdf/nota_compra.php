...
$obj2=new Compra();
$resultado2=$obj2->mostrarUnaCompra($idventa);
$fila1=mysqli_fetch_object($resultado2);
    $proveedor=$fila1->nombre_proveedor;
  

$fechaventa=$fila1->fecha_compra;
...
$pdf->Cell(0,0, 'Proveedor(es): '.$proveedor, 0, 6, 'L', 0, '', 1);
...
<table border="0.1px">
  <thead>
     <tr id="fila1" style="background-color:#e8e8e8;">
                  ...
                  <th style="text-align:center;width: 10%; ">Costo Unitario</th>
                  <th style="text-align:center;width: 10%; ">Precio Venta</th>
                  <th style="text-align:center;width: 10%; ">Precio Venta Fact.</th>
                  <th style="text-align:center;width: 10%; ">Precio ultimo</th>
                  <th style="text-align:center;width: 10%; ">Compra Facturada</th>
...
$pdf->writeHTML($bloqueCabeceraDetalle,false,false,false,false,'');   
               ...
               $totalVenta=0;
                $obj=new Compra();
                $resultado=$obj->mostrarUnaCompra($idventa);
              ...
              $bloqueDatosDetalle=<<<EOF
                                  ...
                                  <tr style="page-break-inside: avoid; " nobr="true">
                                     <th style="text-align:center; width: 10%;">$fila->cantidad_compra</th>
                                     <th style="text-align:left; width: 30%;">$fila->nombre_producto - $fila->codigo_producto</th>
                                     <th style="text-align:center; width: 10%;">$fila->precio_unit_compra</th>
                                     <th style="text-align:center;width: 10%; ">$fila->precio_venta_prod</th> 
                                     <th style="text-align:center; width: 10%;">$fila->precio_venta_prod_Fact</th>
                                     <th style="text-align:center; width: 10%;">$fila->precio_tope</th>
                                     <th style="text-align:center; width: 10%;">$fila->compra_facturada</th>
                                     <th style="text-align:center; width: 10%;">$fila->monto_compra</th>
